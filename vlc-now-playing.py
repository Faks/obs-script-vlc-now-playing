...
class VlcPlayer:
    def __init__(self):
        self.window_title = 'VLC media player'
        self.text_source_name = 'VLC: Now Playing'
        self.no_song_text = ''
    ...
    def description(self):
        return 'Capture VLC Window Title and Update Text Source'
    ...
    def tick(self):
        ...
        song_title: Any | None = self.get_title()

        if song_title and self.get_song_status(song_title):
            song_title = self.no_song_text

        elif not song_title:
            song_title = self.no_song_text

        self.update_text_source(song_title)
